...
write /sys/devices/system/cpu/cpu2/cpufreq/interactive/above_hispeed_delay 20000
...
write /sys/devices/system/cpu/cpu2/cpufreq/interactive/target_loads 90

write /sys/devices/system/cpu/cpu2/cpufreq/interactive/min_sample_time 20000
write /sys/devices/system/cpu/cpu2/cpufreq/interactive/max_freq_hysteresis 40000
...
write /proc/sys/kernel/sched_boost 2
